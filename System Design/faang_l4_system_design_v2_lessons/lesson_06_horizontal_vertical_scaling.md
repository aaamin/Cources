...
- **Scale Up Vs Scale Out** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Stateless Application Servers** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Autoscaling Concepts** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Cpu/Memory/Network Bottlenecks** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Session-State Problems** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Shared Data Layers** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Single Points Of Failure** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Capacity Headroom** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **When Vertical Scaling Is Enough** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Evolution Path** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
For interview purposes, understand **scale up vs scale out** at conceptual depth.
...
For interview purposes, understand **stateless application servers** at conceptual depth.
...
### 3. Autoscaling Concepts

For interview purposes, understand **autoscaling concepts** at conceptual depth.
...
### 4. Cpu/Memory/Network Bottlenecks

For interview purposes, understand **CPU/memory/network bottlenecks** at conceptual depth.
...
### 5. Session-State Problems

For interview purposes, understand **session-state problems** at conceptual depth.
...
### 6. Shared Data Layers

For interview purposes, understand **shared data layers** at conceptual depth.
...
For interview purposes, understand **single points of failure** at conceptual depth.
...
For interview purposes, understand **capacity headroom** at conceptual depth.
...
### 9. When Vertical Scaling Is Enough

For interview purposes, understand **when vertical scaling is enough** at conceptual depth.
...
For interview purposes, understand **evolution path** at conceptual depth.
...
**Scenario:** Evolve a single application server that is CPU-bound during peak traffic.
...
1. What primary problem does **Horizontal & Vertical Scaling** solve?
...
```text
LESSON 6: HORIZONTAL & VERTICAL SCALING
...
**Next:** Lesson 7 — Proxy, Reverse Proxy & API Gateway
