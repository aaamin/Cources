...
- **Polling** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Long Polling** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Sse** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Websockets** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Persistent Connections** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Heartbeats** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Connection Gateways** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Presence** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Reconnection** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Session Routing And Workload-Driven Protocol Choice** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
For interview purposes, understand **polling** at conceptual depth.
...
For interview purposes, understand **long polling** at conceptual depth.
...
For interview purposes, understand **SSE** at conceptual depth.
...
For interview purposes, understand **WebSockets** at conceptual depth.
...
For interview purposes, understand **persistent connections** at conceptual depth.
...
For interview purposes, understand **heartbeats** at conceptual depth.
...
### 7. Connection Gateways

For interview purposes, understand **connection gateways** at conceptual depth.
...
For interview purposes, understand **presence** at conceptual depth.
...
For interview purposes, understand **reconnection** at conceptual depth.
...
### 10. Session Routing And Workload-Driven Protocol Choice

For interview purposes, understand **session routing and workload-driven protocol choice** at conceptual depth.
...
**Scenario:** Choose among polling, SSE, and WebSockets for stock prices, chat, and background job status.
...
1. What primary problem does **Real-Time Communication** solve?
