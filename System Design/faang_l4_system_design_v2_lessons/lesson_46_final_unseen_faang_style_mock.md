...
Users add items to cart, place orders, reserve inventory, pay, and receive confirmation. The system operates in multiple regions.
...
> **Halfway through, require regional failover while preserving order correctness.**
...
> **A region loses connectivity to another region during a large sales event.**
...
- How does your design handle **target-company calibrated prompt**?
- How does your design handle **ambiguous requirement**?
- How does your design handle **mid-interview change**?
- How does your design handle **failure scenario**?
- How does your design handle **complete framework**?
...
**Next:** Final readiness review and company-specific calibration.
