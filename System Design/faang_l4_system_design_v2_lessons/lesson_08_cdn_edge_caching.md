...
- **Origins And Edge Locations** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Static And Media Delivery** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Cache Keys** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Ttl** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Cache Purge** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Signed Urls** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Origin Protection** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Geographic Latency** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Cacheable Vs Uncacheable Content** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Cdn Trade-Offs** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
### 1. Origins And Edge Locations

For interview purposes, understand **origins and edge locations** at conceptual depth.
...
### 2. Static And Media Delivery

For interview purposes, understand **static and media delivery** at conceptual depth.
...
For interview purposes, understand **cache keys** at conceptual depth.
...
For interview purposes, understand **TTL** at conceptual depth.
...
For interview purposes, understand **cache purge** at conceptual depth.
...
For interview purposes, understand **signed URLs** at conceptual depth.
...
For interview purposes, understand **origin protection** at conceptual depth.
...
### 8. Geographic Latency

For interview purposes, understand **geographic latency** at conceptual depth.
...
### 9. Cacheable Vs Uncacheable Content

For interview purposes, understand **cacheable vs uncacheable content** at conceptual depth.
...
For interview purposes, understand **CDN trade-offs** at conceptual depth.
...
**Scenario:** Design delivery for product images used by customers on multiple continents.
...
1. What primary problem does **CDN & Edge Caching** solve?
...
**Next:** Lesson 9 — Caching Fundamentals
