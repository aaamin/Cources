...
Users watching a live sports event can post comments and see new comments with low latency. The system must tolerate very large event spikes.
...
> **Halfway through, add moderation plus per-event rate limits.**
...
> **A message delivery worker repeatedly crashes and retries some comments.**
...
- How does your design handle **realtime communication**?
- How does your design handle **async workflow**?
- How does your design handle **requirement change**?
- How does your design handle **delivery semantics**?
...
**Next:** Lesson 43 — Mock #3 — Data-Heavy / Write-Heavy System
