...
The system serves a very large e-commerce catalog. Users browse categories, fetch product detail pages, filter by attributes, and sort results. Product updates are much less frequent than reads.
...
> **Halfway through, require near-real-time inventory badges without making the whole catalog strongly consistent.**
...
> **One cache tier becomes unavailable during peak traffic.**
...
- How does your design handle **requirements control**?
- How does your design handle **read-heavy workload**?
- How does your design handle **API/data model**?
- How does your design handle **caching/storage**?
