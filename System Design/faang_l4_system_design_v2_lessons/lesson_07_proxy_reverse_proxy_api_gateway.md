...
- **Forward Proxies** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Reverse Proxies** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Api Gateways** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Routing** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Tls Termination** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Edge Authentication** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Rate Limiting** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Request Aggregation** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Service Discovery Concepts** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Differences Among Gateway/Proxy/Load Balancer** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
For interview purposes, understand **forward proxies** at conceptual depth.
...
For interview purposes, understand **reverse proxies** at conceptual depth.
...
For interview purposes, understand **API gateways** at conceptual depth.
...
For interview purposes, understand **routing** at conceptual depth.
...
For interview purposes, understand **TLS termination** at conceptual depth.
...
For interview purposes, understand **edge authentication** at conceptual depth.
...
For interview purposes, understand **rate limiting** at conceptual depth.
...
For interview purposes, understand **request aggregation** at conceptual depth.
...
### 9. Service Discovery Concepts

For interview purposes, understand **service discovery concepts** at conceptual depth.
...
### 10. Differences Among Gateway/Proxy/Load Balancer

For interview purposes, understand **differences among gateway/proxy/load balancer** at conceptual depth.
...
**Scenario:** Place a reverse proxy/API gateway in front of several services and justify what belongs there.
...
1. What primary problem does **Proxy, Reverse Proxy & API Gateway** solve?
...
```text
LESSON 7: PROXY, REVERSE PROXY & API GATEWAY
...
**Next:** Lesson 8 — CDN & Edge Caching
