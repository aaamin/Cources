...
- **Queue Vs Pub/Sub** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Topics** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Partitions** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Offsets** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Consumer Groups** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Retention** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Replay** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Ordering Within Partitions** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Log Compaction Conceptually** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Batch Vs Streaming And Aggregation Windows** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
For interview purposes, understand **queue vs pub/sub** at conceptual depth.
...
For interview purposes, understand **topics** at conceptual depth.
...
For interview purposes, understand **partitions** at conceptual depth.
...
For interview purposes, understand **offsets** at conceptual depth.
...
For interview purposes, understand **consumer groups** at conceptual depth.
...
For interview purposes, understand **replay** at conceptual depth.
...
### 8. Ordering Within Partitions

For interview purposes, understand **ordering within partitions** at conceptual depth.
...
### 9. Log Compaction Conceptually

For interview purposes, understand **log compaction conceptually** at conceptual depth.
...
### 10. Batch Vs Streaming And Aggregation Windows

For interview purposes, understand **batch vs streaming and aggregation windows** at conceptual depth.
...
**Scenario:** Design an event topic consumed independently by analytics, notifications, and fraud detection.
...
1. What primary problem does **Pub/Sub, Streams & Kafka Concepts** solve?
