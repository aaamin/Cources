...
- **Primary Indexes** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Secondary Indexes** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Composite Indexes** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Covering Indexes Conceptually** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Selectivity** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Read Vs Write Amplification** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Query-Driven Indexing** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Index Ordering** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Common Index Mistakes** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Interview Reasoning** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
For interview purposes, understand **primary indexes** at conceptual depth.
...
For interview purposes, understand **secondary indexes** at conceptual depth.
...
For interview purposes, understand **composite indexes** at conceptual depth.
...
### 4. Covering Indexes Conceptually

For interview purposes, understand **covering indexes conceptually** at conceptual depth.
...
For interview purposes, understand **selectivity** at conceptual depth.
...
For interview purposes, understand **read vs write amplification** at conceptual depth.
...
### 7. Query-Driven Indexing

For interview purposes, understand **query-driven indexing** at conceptual depth.
...
For interview purposes, understand **index ordering** at conceptual depth.
...
### 9. Common Index Mistakes

For interview purposes, understand **common index mistakes** at conceptual depth.
...
For interview purposes, understand **interview reasoning** at conceptual depth.
...
**Scenario:** Given a query by (user_id, created_at), reason about a useful composite index.
...
1. What primary problem does **Database Indexing** solve?
