...
Users search rooms, place temporary holds, and pay to confirm bookings. The system must not confirm the same room inventory twice for the same date range.
...
> **Halfway through, add a slow payment provider and client retries.**
...
> **The reservation service crashes after payment succeeds but before confirmation is persisted.**
...
- How does your design handle **business invariants**?
- How does your design handle **duplicate requests**?
- How does your design handle **dependency timeout**?
- How does your design handle **race condition**?
