...
Compute and serve trending topics from a high-volume stream of posts/searches. Results should refresh frequently and support regional views.
...
> **Halfway through, add a celebrity event that causes extreme skew around a few keys.**
...
> **One partition becomes hot enough to create queue lag.**
...
- How does your design handle **hot keys**?
- How does your design handle **traffic skew**?
- How does your design handle **10x evolution**?
