...
- **Producers And Consumers** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Workers** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Acknowledgements** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Visibility Timeouts Conceptually** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Retries** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Dlqs** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **At-Most-Once** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **At-Least-Once** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Duplicates** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Moving Work Off Synchronous Request Paths** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
For interview purposes, understand **producers and consumers** at conceptual depth.
...
For interview purposes, understand **workers** at conceptual depth.
...
For interview purposes, understand **acknowledgements** at conceptual depth.
...
### 4. Visibility Timeouts Conceptually

For interview purposes, understand **visibility timeouts conceptually** at conceptual depth.
...
For interview purposes, understand **DLQs** at conceptual depth.
...
For interview purposes, understand **at-most-once** at conceptual depth.
...
For interview purposes, understand **at-least-once** at conceptual depth.
...
For interview purposes, understand **duplicates** at conceptual depth.
...
### 10. Moving Work Off Synchronous Request Paths

For interview purposes, understand **moving work off synchronous request paths** at conceptual depth.
...
**Scenario:** Move image resizing out of the synchronous upload request using a worker queue.
...
1. What primary problem does **Message Queues & Async Processing** solve?
