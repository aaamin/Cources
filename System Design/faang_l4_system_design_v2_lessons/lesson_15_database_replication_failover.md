...
- **Leader/Follower Replication** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Read Replicas** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Sync Vs Async Replication** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Replication Lag** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Failover** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Split Brain Concept** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Read-After-Write Anomalies** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Replica Promotion** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Availability Vs Freshness** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Operational Trade-Offs** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
For interview purposes, understand **leader/follower replication** at conceptual depth.
...
For interview purposes, understand **read replicas** at conceptual depth.
...
For interview purposes, understand **sync vs async replication** at conceptual depth.
...
For interview purposes, understand **replication lag** at conceptual depth.
...
### 6. Split Brain Concept

For interview purposes, understand **split brain concept** at conceptual depth.
...
### 7. Read-After-Write Anomalies

For interview purposes, understand **read-after-write anomalies** at conceptual depth.
...
For interview purposes, understand **replica promotion** at conceptual depth.
...
### 9. Availability Vs Freshness

For interview purposes, understand **availability vs freshness** at conceptual depth.
...
For interview purposes, understand **operational trade-offs** at conceptual depth.
...
**Scenario:** Explain what a user can observe when a write reaches the leader but a read goes to a lagging replica.
...
1. What primary problem does **Database Replication & Failover** solve?
