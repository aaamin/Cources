...
- **Strong Consistency** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Eventual Consistency** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Read-After-Write** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Monotonic Reads Conceptually** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Cap Under Partitions** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Read/Write Quorums** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Conflicts** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Availability Trade-Offs** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Operation-Specific Consistency** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Correctness Language** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
For interview purposes, understand **strong consistency** at conceptual depth.
...
For interview purposes, understand **eventual consistency** at conceptual depth.
...
For interview purposes, understand **read-after-write** at conceptual depth.
...
### 4. Monotonic Reads Conceptually

For interview purposes, understand **monotonic reads conceptually** at conceptual depth.
...
### 5. Cap Under Partitions

For interview purposes, understand **CAP under partitions** at conceptual depth.
...
For interview purposes, understand **read/write quorums** at conceptual depth.
...
For interview purposes, understand **conflicts** at conceptual depth.
...
### 8. Availability Trade-Offs

For interview purposes, understand **availability trade-offs** at conceptual depth.
...
### 9. Operation-Specific Consistency

For interview purposes, understand **operation-specific consistency** at conceptual depth.
...
### 10. Correctness Language

For interview purposes, understand **correctness language** at conceptual depth.
...
**Scenario:** Choose consistency expectations for likes, profile settings, and seat reservations.
...
1. What primary problem does **Consistency, CAP & Quorums** solve?
