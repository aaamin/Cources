...
- **Horizontal Partitioning** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Hash Partitioning** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Range Partitioning** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Geographic Partitioning** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Partition Keys** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Hot Partitions** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Scatter-Gather Queries** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Rebalancing** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Resharding** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
- **Adversarial Shard-Key Analysis** — explain what problem it solves, how it works conceptually, when to use it, and its trade-offs.
...
For interview purposes, understand **horizontal partitioning** at conceptual depth.
...
For interview purposes, understand **hash partitioning** at conceptual depth.
...
For interview purposes, understand **range partitioning** at conceptual depth.
...
For interview purposes, understand **geographic partitioning** at conceptual depth.
...
For interview purposes, understand **partition keys** at conceptual depth.
...
For interview purposes, understand **hot partitions** at conceptual depth.
...
### 7. Scatter-Gather Queries

For interview purposes, understand **scatter-gather queries** at conceptual depth.
...
For interview purposes, understand **resharding** at conceptual depth.
...
### 10. Adversarial Shard-Key Analysis

For interview purposes, understand **adversarial shard-key analysis** at conceptual depth.
...
**Scenario:** Choose a shard key for chat messages and then invent a workload that creates a hotspot.
...
1. What primary problem does **Partitioning & Sharding** solve?
