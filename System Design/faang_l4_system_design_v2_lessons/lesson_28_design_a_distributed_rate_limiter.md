...
- sharding
- per-user/per-tenant/global quotas
- clock issues
- regional limits
- fail-open vs fail-closed
- hot keys and failure behavior
...
> **Support per-user, per-tenant, and global quotas across multiple regions.**
...
### 6. Per-User/Per-Tenant/Global Quotas
...
### 10. Hot Keys And Failure Behavior
